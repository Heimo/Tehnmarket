	...
	<div class="main" style="">
		<div class="container">
			...
			<form action="favourites" method="get">
				<button type="submit" style="float: left;">Get Favourite
					Products</button>
			</form>

			<form action="editUser" method="get">
				<button type="submit" style="float: left;">Edit User Data</button>
			</form>
			<c:if test="${user.admin }">
				<form action="addProduct" method="get">
					<button type="submit" style="float: right;">Add Product</button>
				</form>

				<form action="listProducts" method="get">
					<button type="submit" style="float: right;">Edit Products</button>
				</form>
